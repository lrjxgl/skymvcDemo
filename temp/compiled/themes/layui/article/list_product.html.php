...
?>
				<div class="item btc-<?php echo $this->_var['k']; ?> ">
					<div class="pd">
						<div class="img">
							<a href="<?php echo R("/index.php?m=article&a=show&id=".$this->_var["c"]["id"]."");?>"><img src="<?php echo images_site($this->_var['c']['imgurl']); ?>.middle.jpg"></a>
						</div>
						<div class="title">
							<a href="<?php echo R("/index.php?m=article&a=show&id=".$this->_var["c"]["id"]."");?>"><?php echo $this->_var['c']['title']; ?></a>
						</div>
		...
		<script src="<?php echo $this->_var['skins']; ?>/article/list_product.js"></script>
	</body>
